# -*- coding: utf-8 -*-
"""Implementation of Testing with Concept Activation Vectors

References
----------

[1] B. Kim et al., ‘Interpretability Beyond Feature Attribution: Quantitative
Testing with Concept Activation Vectors (TCAV)’, arXiv:1711.11279 [stat], 2018,
[Online]. Available: http://arxiv.org/abs/1711.11279.
...
def create_training_set(concepts, bottleneck, acts):
    ...
    min_data_points = np.min(
        [acts[concept][bottleneck].shape[0] for concept in concepts])
...
class CAV:
    """Concept Activation Vectors class.

    Parameters
    ----------
    concepts :
        Set of concepts used for the CAV.
    bottleneck : 
        Bottleneck used for the CAV.
    ...
    def train(self, acts):
        x, labels, labels2text = CAV.create_training_set(
